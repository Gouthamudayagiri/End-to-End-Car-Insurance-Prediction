    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            if model_report['best_score'] < self.model_trainer_config.expected_accuracy:
                logging.info(f"No best model found with score more than base score. Best: {model_report['best_score']}, Expected: {self.model_trainer_config.expected_accuracy}")
                raise Exception(f"No best model found with score more than base score")

import os
from insurance_charges.constants import *
...
class DataIngestionConfig:
    ...
    table_name: str = TABLE_NAME  # NEW: For PostgreSQL table name
    schema_name: str = SCHEMA_NAME  # NEW: For PostgreSQL schema name
